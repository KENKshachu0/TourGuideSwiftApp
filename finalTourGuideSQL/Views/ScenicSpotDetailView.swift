        ...
        ScrollView {
            VStack {
                ...
                HStack{
                    ...
                    Button(action: {
                        // Latitude and longitude of the scenic spot
                    let latitude = scenicSpot.desLat
                    let longitude = scenicSpot.desLon
